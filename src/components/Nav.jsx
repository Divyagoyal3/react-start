...
const Nav = () => {
    return (
        <div className='w-full h-[100px] flex justify-between items-center px-8'>
            ...
            <form action="" className='w-[70%] h-[60px] bg-white flex items-center px-5 gap-5 shadow-md rounded-md'>
                <IoSearch className='text-green-500 w-[20px] h-[20px] rounded shadow-lg' />
                <input type="text" placeholder='Search food items' className=' w-[300px] text-[20px] border-none outline-none w-[300px] h-[40px] rounded-md ' />
            </form>
