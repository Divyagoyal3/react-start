    ...
    return (
        <div className='w-[300px] h-[400px] bg-white p-3 rounded-lg flex flex-col gap-3 shadow-lg hover:border-2
         border-green-300'>
            ...
            <div className='w-full h-[40px] bg-green-350 rounded-md flex justify-center items-center text-white font-semibold cursor-pointer hover:bg-green-600 transition-all duration-200'>
                Add to Cart
            </div>
        </div>
